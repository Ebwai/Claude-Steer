...
- [产品介绍：痛点、需求、新概念与新机制](https://www.bilibili.com/video/BV1MmMG6ME4J)
- [实战演示 Demo](https://www.bilibili.com/video/BV16uTR6gEof)
...
| 亮点 | 更新内容 |
|:-----|:---------|
| 🔔 **独立通知中心** | 权限请求迁移到独立置顶窗口，主窗口最小化后也不会错过关键审批。 |
| 🗂️ **按项目聚合请求** | 按正在运行的项目分区展示权限请求，提供紧凑操作与可展开的工具调用详情。 |
| 🧹 **更大的监控空间** | 移除实时面板内嵌通知区，为 Agent 列表与上下文信息释放更多纵向空间。 |
| ⚙️ **灵活的通知行为** | 可配置窗口置顶和自动打开；关闭窗口时隐藏到托盘，待处理请求不会丢失。 |
